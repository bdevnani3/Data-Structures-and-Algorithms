...
public class BST<T extends Comparable<T>> implements BSTInterface<T> {
    ...
    /**
     * This is a helper method that, recursively adds
     * the data to the Binary Tree
     *
     *
    ...
    private Node<T> remove(Node<T> node, T data) {
        if (node == null) {
            ...
            Node<T> p = getPredecessor(node.getLeft());
            node.setData(p.getData());
            node.setRight(remove(node.getRight(), p.getData()));
            size--;
    ...
    /**
     * This is a helper method that, recursively returns the next smallest
     * element in the Binary Tree. This element is called the predecessor.
     *
     * @param node  current node
     */
    ...
    */
     ...
     *
     * First is the data in the node, then the data on the
     * left, followed by the data on
